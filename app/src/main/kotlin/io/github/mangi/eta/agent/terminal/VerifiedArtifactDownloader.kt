...
internal data class VerifiedArtifact(
    ...
    val sha256: String,
    val sizeBytes: Long,
    /** Mirrors to try before the official address; mirrors only change the transport path, while the full size and digest verification still follow the artifact manifest. */
