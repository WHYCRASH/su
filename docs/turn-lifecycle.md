...
- Added eight regression cases; existing compaction fixtures now use recognized summary prefixes rather than an arbitrary compressed-marker system string. Local diff/XML validation only; CI tests and device verification pending.
